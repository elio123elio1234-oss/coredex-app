...
export function usePdfLabels(): PdfLabels {
  ...
  return useMemo<PdfLabels>(
    () => ({
      ...
      poincareTitle: tr('pdfStatsVariability'),
      poincareCaption: tr('pdfPoincareCap'),
      tachogramTitle: tr('pdfStatsVariability'),
      ...
      howToReadTitle: tr('pdfHowToTitle'),
      howToRead: [tr('pdfHow1'), tr('pdfHow2'), tr('pdfHow3'), tr('pdfHow4')],
