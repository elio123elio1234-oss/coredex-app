...
export const he: Record<TranslationKey, string> = {
  ...
  pdfProcBody:
    ...
    ' ב-{notch} Hz בפאזה אפס (כך שאף מרווח אינו מוזז בזמן), והחלקה קלה — לפני שהוא מצויר או נמדד. המכשיר מקליט שני ערוצים: לידים I ו-II נמדדים, ואילו III, aVR, aVL ו-aVF מחושבים מהם לפי משוואות איינטהובן וגולדברגר — אריתמטיקה מדויקת, לא אלקטרודות נוספות. כל רצועה מודפסת ב-25 mm/s וב-10 mm/mV עם פולס כיול של 1 mV, כך שאפשר לאמת את ההגבר בעין ולא לסמוך עליו.',
