...
export const he: Record<TranslationKey, string> = {
  ...
  /* בדיקה אחת חצתה סף. לא התרעה — זו כל המהות של כלל שני המצבים
     (`IdentityAlert`), והניסוח חייב לשאת אותו אחרת ההבחנה מתה בממשק. */
  insAlertSingle: 'הבדיקה הזו שונה מקו הבסיס שלכם: {kinds}. בדיקה אחת לבדה אינה מגמה.',
  insAlertRepeated: 'אותו הבדל ב-{n} בדיקות רצופות: {kinds}. שווה להראות לרופא.',
