...
export const he: Record<TranslationKey, string> = {
  ...
  insBuiltMeaning:
    'בדיקה אחת מראה רק את הרעש שלה עצמה בין פעימה לפעימה. הטווח המוצלל מתמלא ככל שנוספות בדיקות — זו האפליקציה שלומדת כמה אתם באמת משתנים.',

  /* פעימות שלא נכנסו לממוצע של בדיקה אחת. */
  insRejectedTitle: '{n} פעימות לא נכללו בממוצע',
  insRejectedBody:
    'פעימה יוצאת מהממוצע בגלל התזמון שלה — היא הגיעה מוקדם, כלומר התחילה במקום אחר מהרגיל — או בגלל הצורה שלה. שניהם ממצאים רגילים לחלוטין בהקלטה תקינה. הקו העבה הוא הפעימה שכן שימשה.',
  ...
  insDeviationMeaning:
    'כל מספר הוא הבדיקה הזו מול הבדיקות הקודמות שלכם — לא מול טווח נורמה. הפרש הוא משהו להסתכל עליו יחד עם הרופא, לא תוצאה.',
